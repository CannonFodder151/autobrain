...
- fix(backend): alembic migration `aut2375_fuel_history_index` `down_revision` rebased from `z2a3b4c5d6e7` to `aut1859_fuel_price_alerts` so the migration chain has a single head (was two: `aut1859_fuel_price_alerts` + `aut2375_fuel_history_index`).
