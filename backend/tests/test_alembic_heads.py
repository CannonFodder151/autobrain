...
Also asserts revision IDs are unique (AUT-918/AUT-996: add_devices reused
a1b2c3d4e5f6 already claimed by add_user_max_vehicles, so alembic refused to
load the script tree and bootstrap fell back to create_all).
