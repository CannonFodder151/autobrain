...
# Single-parent child of current main head m3rge06 (post-AUT-2677).
# No merge needed: this migration only adds the electricity_logs table
# (AUT-702 single-head guard).
