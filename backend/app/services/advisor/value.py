"""Value module (AUT-2445): deterministic market valuation.
...
adjustment, then derives a tight low/high band. No AI, no 9Router.
"""
...
from app.services.advisor._common import (
    CURRENCY,
    _MIN_VALUE,
    _MAX_VALUE,
    _safe,
