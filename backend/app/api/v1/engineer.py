...
async def search_engineers(
    ...
    fromf: dt_time | None = None
    fromt: dt_time | None = None
    if available_from:
        try:
...
async def create_engineer_endpoint(
    ...
    eng_full = await get_engineer_by_id(db, eng.id, load_reviews=False)
    return EngineerResponse(
        id=eng_full.id,
        display_name=eng_full.display_name,
        email=eng_full.email,
        phone=eng_full.phone,
        lat=eng_full.lat,
        lon=eng_full.lon,
        postcode=eng_full.postcode,
        address=eng_full.address,
        specialties=eng_full.specialties or [],
        certifications=eng_full.certifications or [],
        years_experience=eng_full.years_experience,
        rating=eng_full.rating,
        review_count=eng_full.review_count,
        price_per_hour=eng_full.price_per_hour,
        price_per_job_min=eng_full.price_per_job_min,
        price_per_job_max=eng_full.price_per_job_max,
        availability=eng_full.availability or [],
        is_verified=eng_full.is_verified,
        verification_status=eng_full.verification_status,
        created_at=eng_full.created_at.isoformat() if eng_full.created_at else None,
        reviews=[],
    )
