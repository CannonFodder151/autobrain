...
Consolidates duplicated artefacts from router_client.py so all 5 AI modules
share a single source of truth for system prompts, schema whitelists,
immutable-key sets, and validation logic.
"""
