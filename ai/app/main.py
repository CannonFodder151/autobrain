...
app = FastAPI(
    ...
    version=os.environ.get("APP_VERSION", "0.3.268"),  # bump-version.sh keeps this in sync
...
async def health() -> dict:
    logger.info("health_check", router_url=router_url(), router_enabled=router_enabled())
    return {
        "status": "ok",
        "service": "autobrain-ai",
        "version": os.environ.get("APP_VERSION", "0.3.268"),
    }
